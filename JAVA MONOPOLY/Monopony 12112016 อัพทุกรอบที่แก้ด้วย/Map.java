...
public class Map{
    ...
    public Map() {
        ...
        map.add(0,new Corner(0,"Start","",2000000));
        ...
        map.add(4, new Deed(4,"Tax","/Pic/TAX.png","/Pic/tax.png",2000000));
        ...
        map.add(10, new Corner(10,"Jail","",2000000));
        ...
        map.add(20, new Corner(20,"FreeParking","",2000000));
        ...
        map.add(30, new Corner(30,"Start","",2000000));
